...
export default class DeviceMeta {
  ...
  public static isPhone(userAgentParameter?: string): boolean {
  ...
  public static isPhoneOrTablet(userAgentParameter?: string): boolean {
    const userAgent = userAgentParameter || DeviceMeta.getUserAgent();
    const userAgentPart = userAgent.slice(0, 4);
  ...
  public static isTablet(userAgentParameter?: string): boolean {
    const userAgent = userAgentParameter || DeviceMeta.getUserAgent();

    return DeviceMeta.isPhoneOrTablet(userAgent) && !DeviceMeta.isPhone(userAgent);
  }

  public static getOs(userAgentParameter?: string) {
    try {
      const userAgent = userAgentParameter || DeviceMeta.getUserAgent();
  ...
  public static getBrowser(userAgentParameter?: string) {
    const userAgent = userAgentParameter || DeviceMeta.getUserAgent();
    ...
    if (userAgent.includes('MSIE')) {
      return DeviceBrowser.IE;
    }
    // EDGE
    if (userAgent.includes('Edge')) {
      return DeviceBrowser.EDGE;
    }
    // SAFARI
    ...
    if (userAgent.includes('Opera')) {
      return DeviceBrowser.OPERA;
    }
    // YANDEX BROWSER
    if (userAgent.includes('YaBrowser')) {
      return DeviceBrowser.YANDEX;
    }
    // OTHERS
    return DeviceBrowser.OTHER;
  }

  public static getLayout(userAgentParameter?: string) {
    const userAgent = userAgentParameter || DeviceMeta.getUserAgent();
